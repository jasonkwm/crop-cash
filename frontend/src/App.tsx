...
function App() {
  ...
  const logoutView = (
    <div className="flex flex-col justify-between">
      ...
      <div className="flex flex-col gap-4 w-[90%] text-center justify-center items-center m-auto font-normal">
  ...
  return (
    <>
      <Navbar />
      <div className="w-screen max-w-[1920px] flex flex-col items-center justify-center md:flex-row md:justify-around p-4 font-normal">
